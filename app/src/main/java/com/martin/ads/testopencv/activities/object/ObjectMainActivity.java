package com.martin.ads.testopencv.activities.object;
...
public class ObjectMainActivity extends BaseActivity {
            ...
            public void authorized(int requestCode) {
                ...
                switch (requestCode) {
                    case REQUEST_CODE_DETECTION:
                        startActivity(new Intent(ObjectMainActivity.this, ObjectDetectingActivity.class));
                        break;
                    case REQUEST_CODE_TRACK:
                        startActivity(new Intent(ObjectMainActivity.this, ObjectTrackingActivity.class));
                        break;
                    default:
                        break;
                }
